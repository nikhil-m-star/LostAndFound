  ...
  return (
    <div className="report-container" style={{ maxWidth: '1000px', margin: '40px auto', padding: '20px' }}>
      ...
      <div style={{ marginBottom: '40px', borderBottom: '4px solid var(--neo-black)', paddingBottom: '24px' }}>
        <h1 style={{ fontSize: '3rem', color: 'var(--neo-black)', marginBottom: '8px' }}>REPORT LOST ITEM</h1>
      ...
      <div className="report-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '40px' }}>
        ...
        <div className="form-left">
          <div className="neo-label" style={{ marginBottom: '16px', fontSize: '18px' }}>REFERENCE PHOTOS</div>
        ...
        <div className="form-right form-lost">
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            <div>
              ...
              <input className="neo-input" value={title} onChange={(e) => setTitle(e.target.value)} placeholder="What did you lose?" required />
            </div>

            <div>
              <label className="neo-label">DESCRIPTION</label>
              <textarea className="neo-textarea" value={description} onChange={(e) => setDescription(e.target.value)} placeholder="Describe the lost item..." required style={{ minHeight: '120px' }} />
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
              ...
              <div>
                <label className="neo-label">DATE LOST</label>
            ...
            <div>
              ...
              <input className="neo-input" value={location} onChange={(e) => setLocation(e.target.value)} placeholder="Where was it last seen?" />
            </div>
