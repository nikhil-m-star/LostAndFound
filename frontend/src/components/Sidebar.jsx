...
import { FiHome, FiSearch, FiCpu, FiMessageSquare, FiUsers, FiBox } from 'react-icons/fi'
  ...
  return (
    <aside className="sidebar">
      ...
      <nav>
        ...
        <NavLink to="/my-reports" className={({ isActive }) => isActive ? 'active' : ''}><FiBox style={{ width: 18, height: 18 }} /> <span>My Reports</span></NavLink>
        <NavLink to="/admin/users" className={({ isActive }) => isActive ? 'active' : ''}><FiUsers style={{ width: 18, height: 18 }} /> <span>All Users</span></NavLink>
      </nav>
    </aside>
  )
}
